# Graph Report - rekam-medis-ponpes  (2026-08-12)

## Corpus Check
- 610 files · ~233,942 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4266 nodes · 6106 edges · 497 communities (430 shown, 67 thin omitted)
...
- OperationalNotificationController.php
...
- ReferralDocumentController.php
...
1. `User` - 275 edges
2. `AuditLogService` - 74 edges
3. `MedicalVisit` - 65 edges
4. `Referral` - 59 edges
5. `VisitDischarge` - 51 edges
6. `Controller` - 49 edges
7. `ReferralService` - 35 edges
8. `ObservationEpisode` - 30 edges
9. `ClinicalConsultation` - 29 edges
...
- `createUatStaff()` --calls--> `Role`  [INFERRED]
  tests/Feature/UAT/Phase4BEndToEndUatTest.php → app/Models/Role.php

## Import Cycles
- None detected.

## Communities (497 total, 67 thin omitted)

### Community 0 - "ClinicalConsultation"
Cohesion: 0.11
Nodes (4): transmit(), ClinicalConsultation, ClinicalConsultationVersion, FakeClinicalConsultationTransport
...
### Community 4 - "User"
Cohesion: 0.05
Nodes (13): User, ActivityRestrictionPolicy, ClinicalConsultationPolicy, HealthcarePartnerPolicy, MedicationAdministrationPolicy, MedicationOrderPolicy, ObservationEpisodePolicy, ReportPolicy (+5 more)
...
Cohesion: 0.07
Nodes (8): ReferralCompanionController, StoreFollowUpPlanRequest, StoreVisitDischargeRequest, ApplyGateSyncRequest, ApproveIdentityMappingRequest, StoreReferralCompanionRequest, StoreReferralRequest, Illuminate\Foundation\Http\FormRequest
...
Cohesion: 0.08
Nodes (7): HealthcarePartner, AuditLogService, ClinicalAssessmentService, ClinicalConsultationService, MedicalVisitService, ObservationService, ReferralService

### Community 17 - "Controller"
Cohesion: 0.10
Nodes (8): Controller, ReferralReturnReviewController, ReferralStatusController, ReferralTransportController, StoreReferralReturnReviewRequest, StoreReferralStatusEventRequest, StoreReferralTransportRequest, Illuminate\Foundation\Auth\Access\AuthorizesRequests
...
### Community 48 - "Illuminate\Database\Eloquent\Concerns\HasUlids"
Cohesion: 0.05
Nodes (17): ClinicalAction, ConsultationLocalDecision, GateSyncRun, HealthcarePartnerContact, IntegrationDeliveryAttempt, ObservationRecord, PatientEmergencyContact, PatientHealthProfile (+9 more)
...
### Community 64 - "GateSyncApplyService"
Cohesion: 0.20
...
Cohesion: 0.03
Nodes (11): ClinicalAssessment, ClinicalConsultationTransmission, ExternalClinicalAdvice, MedicationAdministration, MedicationOrder, MedicationSafetyAcknowledgement, ObservationHandover, OperationalNotification (+3 more)
...
Cohesion: 0.09
Nodes (11): DashboardController, ReferralController, HealthReportController, QueryReportRequest, ClinicalDashboardService, ManagementDashboardService, OperationalDashboardService, AppLayout (+3 more)
...
### Community 180 - "IntegrationOutboxService"
Cohesion: 0.21
...
### Community 190 - "GateIdentityMapping"
Cohesion: 0.14
Nodes (6): Carbon, self, GateIdentityMapping, GateIdentityReconciliationService, HealthReportService, Illuminate\Contracts\Pagination\LengthAwarePaginator
...
Cohesion: 0.04
Nodes (48): [0.11.0] — 2026-08-05 (Phase 3B), [0.12.0] — 2026-08-09 (Phase 3B Hardening & Final Validation), [0.13.0] — 2026-08-09 (Phase 3C1 Visit Discharge, Follow-up & Operational Handoff), [0.15.0] — 2026-08-09 (Phase 4A Gate SSO, Secure Sync Apply & Identity Hardening), [0.16.0] — 2026-08-10 (Phase 4B Staging Integration, End-to-End UAT & Attendance Sandbox), [0.17.0] — 2026-08-10 (Phase 4C Production Deployment Hardening, Runbooks & Go-Live Readiness), [0.17.1] — 2026-08-10 (Phase 4C2 Controlled Cutover Plan & Preflight State), [0.18.0] — 2026-08-10 (Phase 4C2 Production Cutover Complete & Live Validation) (+40 more)
...
Cohesion: 0.17
Nodes (11): Known Issues and Open Questions, Phase 3B & 3C Status, Phase 4A Gate SSO & Sync Status, Phase 4B Staging Integration & UAT Status, Phase 4C2 Production Cutover Status, Phase 4C Production Hardening Status, Phase 4D2 Independent Operational Evidence Verification Status, Phase 4D Operational Acceptance Status (+3 more)
...
## Knowledge Gaps
- **2142 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+2137 more)
...
- **Why does `User` connect `User` to `ClinicalConsultation`, `ObservationRecordPolicy`, `Referral`, `GateAuthenticationService`, `Medicine`, `PatientAllergyPolicy`, `AuditLogService`, `VisitFollowUpPlan`, `PersonPolicy`, `OperationalNotificationPolicy`, `ObservationEpisode`, `ReferralVersion`, `UserNotification`, `DashboardPolicy`, `VitalSign`, `Illuminate\Http\RedirectResponse`, `MedicineBatchPolicy`, `ClinicalOperationalHandoff`, `Person.php`, `ClinicalActionPolicy`, `Illuminate\Database\Eloquent\Concerns\HasUlids`, `GateSyncPolicy`, `Role.php`, `ObservationHandoverPolicy`, `PatientHealthProfilePolicy`, `IntegrationOutboxService`, `VisitDischargeVersion`, `StockLocationPolicy`, `StockMovementPolicy`, `GateIdentityMapping`, `GateSyncApplyService`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `AuditLogPolicy`, `ClinicalAssessmentPolicy`, `MedicalVisitPolicy`, `OperationalNotificationService`, `VisitDischarge`, `MedicinePolicy`, `GateMappingPolicy`, `PatientPolicy.php`, `IntegrationOutboxEvent`, `ReferralDocumentController.php`, `IntegrationIdentityConflict`, `Person`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `VisitDischarge` connect `VisitDischarge` to `AttendanceHealthDispositionDTO`, `OperationalNotificationService`, `User`, `Illuminate\Http\RedirectResponse`, `ClinicalOperationalHandoff`, `Person.php`, `GateIdentityMapping`, `Person`, `Illuminate\Database\Eloquent\Concerns\HasUlids`, `VisitFollowUpPlan`, `ClinicalOperationalHandoffController.php`, `Illuminate\Database\Eloquent\Relations\HasOne`, `VisitDischargeVersion`, `IntegrationOutboxEvent`, `ObservationEpisode`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `IntegrationOutboxEvent` connect `IntegrationOutboxEvent` to `IntegrationOutboxController.php`, `Illuminate\Database\Eloquent\Concerns\HasUlids`, `IntegrationOutboxService`, `ObservationEpisode`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
